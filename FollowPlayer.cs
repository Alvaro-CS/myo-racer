...
{
    private Transform car=null;//before instantiating, it was public
    ...
    private Boolean isCarSet = false;
    ...
    void Update()
    {
        if (!isCarSet|| gameManager.getIsCarCreated())
        {
            car = gameManager.getInstantiatedCar().transform;
            isCarSet = true;
        }
    }
    void LateUpdate()
